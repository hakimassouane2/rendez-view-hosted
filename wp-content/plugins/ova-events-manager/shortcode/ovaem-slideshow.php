...
add_shortcode('ovaem_slideshow', 'ovaem_slideshow');
function ovaem_slideshow($atts, $content = null) {
    ...
    $atts = extract( shortcode_atts(
        ...
        $html = '';
	    $html .= '<div class="main_slider main_slider_auto main_slider_v1 owl-carousel '.$class.'" data-height_desk="'.$height_desk.'"  data-height_ipad="'.$height_ipad.'" data-height_mobile="'.$height_mobile.'" data-loop="'.$loop.'" data-auto_slider="'.$auto_slider.'" data-duration="'.$duration.'" data-navigation="'.$navigation.'" data-padding_top_desk="'.$padding_top_desk.'" data-padding_top_ipad="'.$padding_top_ipad.'" data-padding_top_mobile="'.$padding_top_mobile.'" >';
...
if(function_exists('vc_map')){
		...
		vc_map( array(
			 "name" => esc_html__("Slideshow Event Basic", 'ovaem-events-manager'),
			 "base" => "ovaem_slideshow",
			 "class" => "",
